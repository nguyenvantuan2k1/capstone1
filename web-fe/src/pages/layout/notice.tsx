    ...
    <div>
      <Spin tip="Loading..." indicator={antIcon} spinning={loading}>
        <Tabs defaultActiveKey="1">
          <TabPane tab={`chú ý(${noticeListFilter('notification').length})`} key="1">
            <List
          ...
          <TabPane tab={`Thông tin(${noticeListFilter('message').length})`} key="2">
            <List
          ...
          <TabPane tab={`Sắp tới(${noticeListFilter('event').length})`} key="3">
            <List
